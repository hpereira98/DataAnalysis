...
INSERT INTO sa_purchase(quantity, total_cost, id_supplier, id_product, submitted_date, id_purchase, id_purchase_details)
SELECT pod.quantity, pod.quantity*pod.unit_cost, po.supplier_id, pod.product_id, po.submitted_date, po.id, pod.id
...
INSERT INTO sa_sale(quantity, total_cost, discount, id_product, id_client, id_shipper, id_employee, order_date, id_sale, id_sale_details)
SELECT od.quantity, od.quantity * od.unit_price, od.discount, od.product_id, o.customer_id, COALESCE(o.shipper_id, 0), o.employee_id, o.order_date, o.id, od.id
